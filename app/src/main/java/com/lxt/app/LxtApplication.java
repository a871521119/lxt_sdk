...
public class LxtApplication extends Application {
    ...
    private static final String TAG = "LxtApplication";

    private ApplicationLike tinkerApplicationLike;

    private static LxtApplication lxtApplication;
    ...
    public void onCreate() {
        ...
        LXTSDK.init(this).setDebug(true);
    }

    public static Context getAppContext() {
        return lxtApplication;
    }

    public static Resources getAppResources() {
        return lxtApplication.getResources();
    }
