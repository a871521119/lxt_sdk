...
public class MyClassBeen extends BaseBeen {
    ...
    private Object SpecialtyEnTitle;
    ...
    public Object getSpecialtyEnTitle() {
        return SpecialtyEnTitle;
    }

    public void setSpecialtyEnTitle(Object SpecialtyEnTitle) {
    ...
    public List<MyClassBeen> getData() {
        return data;
    }

    public void setData(List<MyClassBeen> data) {
        this.data = data;
    }
}
