...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = LxtApplication.getAppContext().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = LxtApplication.getAppContext().getResources().getDisplayMetrics().scaledDensity;
