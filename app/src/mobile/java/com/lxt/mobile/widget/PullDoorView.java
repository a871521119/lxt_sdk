...
public class PullDoorView extends RelativeLayout {
    ...
    OnHalfViewListener halfViewListener;
    boolean isPullEnadble = false;
    ...
    public void setIsPullEnadble(boolean enble) {
        this.isPullEnadble = enble;
    }
    ...
    private void setupView() {
        ...
        //mImgView.setImageResource(R.mipmap.boot_launch_bg); // 默认背景
        addView(mImgView);
    }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mDelY < 0) {
                    ...
                    if (Math.abs(mDelY) > mScreenHeigh / 2) {
                        ...
                        mCloseFlag = true;
                        if (halfViewListener != null&&isPullEnadble) {
                            halfViewListener.halfViewListener();
                        }
                    } else {
    ...
    public void setOnHalfViewListener(OnHalfViewListener halfViewListener) {
        this.halfViewListener = halfViewListener;
    }
     ...
     * 超过一半时回调
     */
    public interface OnHalfViewListener {
        void halfViewListener();
    }
}
