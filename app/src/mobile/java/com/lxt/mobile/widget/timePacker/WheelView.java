...
public class WheelView extends View {
    ...
    private static final int VALUE_TEXT_COLOR = 0xFF77b82a;
    ...
    private static  int TEXT_SIZE = 45;


    private static final int ITEM_OFFSET = TEXT_SIZE / 50;
    ...
    public WheelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TEXT_SIZE = Utils.dip2px(context, 15);
        initData(context);
    }
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        itemsWidth += (ADDITIONAL_ITEMS_SPACE+300); // make it some more
...
//        private WeakReference<TeacherDetail> mActivity;
//        public TeacherDetailHandler(TeacherDetail tActivity){
//            mActivity = new WeakReference<TeacherDetail>(tActivity);
//        }
//        @Override
//        public void handleMessage(Message msg) {
//            super.handleMessage(msg);
//            TeacherDetail tActivity = mActivity.get();
//            if(null == tActivity){
//                return;
//            }
