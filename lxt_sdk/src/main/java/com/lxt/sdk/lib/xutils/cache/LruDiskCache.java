package com.lxt.sdk.lib.xutils.cache;
...
import com.lxt.sdk.lib.xutils.common.util.FileUtil;
import com.lxt.sdk.lib.xutils.common.util.IOUtil;
import com.lxt.sdk.util.LogUtil;
import com.lxt.sdk.lib.xutils.common.util.MD5;
import com.lxt.sdk.lib.xutils.common.util.ProcessLock;
import com.lxt.sdk.lib.xutils.config.DbConfigs;
import com.lxt.sdk.lib.xutils.db.sqlite.WhereBuilder;
import com.lxt.sdk.lib.xutils.ex.DbException;
import com.lxt.sdk.lib.xutils.ex.FileLockedException;
...
public final class LruDiskCache {
    ...
    private LruDiskCache(String dirName) {
        this.cacheDb = lxt.getDb(DbConfigs.HTTP.getConfig());
