...
import com.lxt.sdk.lib.xutils.http.annotation.HttpRequest;
import com.lxt.sdk.lib.xutils.http.app.DefaultParamsBuilder;
import com.lxt.sdk.lib.xutils.http.app.HttpRetryHandler;
import com.lxt.sdk.lib.xutils.http.app.ParamsBuilder;
...
public class RequestParams extends BaseParams {
    ...
    /*package*/ void init() throws Throwable {
        ...
        if (TextUtils.isEmpty(uri) && getHttpRequest() == null) {
            throw new IllegalStateException("uri is empty && @HttpPost == null");
        }
