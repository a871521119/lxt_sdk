...
public class MNSClient implements MNS {
    ...
    public MNSClient(Context context, String endpoint, CredentialProvider credentialProvider, ClientConfiguration conf) {
        ...
        ClientConfiguration conf1 = (conf == null ? ClientConfiguration.getDefaultConf() : conf);

        internalRequestOperation = new MNSInternalRequestOperation(context, endpointURI, credentialProvider, conf1);
    }
